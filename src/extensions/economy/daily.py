...
async def daily(ctx: lightbulb.Context) -> None:
    ...
    match scenario:
        case 1: # The Choice of Chests
            ...
            embed.set_thumbnail('assets/img/general/daily/treasure_chest.png')
            embed.add_field(name='<:small_chest:1265769485441175562> - Old Chest', value='This weathered and timeworn chest may hold a hidden treasure of unknown worth, offering an element of mystery and nostalgia.')
            embed.add_field(name='<:medium_chest:1265769466109890693> - Standard Chest', value='The middle-of-the-road option, this chest offers a reliable chance at a decent haul of coins, without any frills or extravagance.')
            embed.add_field(name='<:large_chest:1265769448095092777> - Luxurious Chest', value='The epitome of opulence, this chest tends to promise high-value rewards, making it the grandest and most alluring choice among the three.')
        ...
        case 3: # Enchanted Encounter
            ...
            embed.add_field(name='<:sleeping_fox:1265769415014879232> - Leave the Fox Alone', value="Let the fox rest peacefully and continue with your day.")
            embed.set_footer(text=f'Requested by {ctx.author.global_name}', icon=ctx.author.display_avatar_url)
