...
plugin = lightbulb.Plugin('Translator', default_enabled_guilds=DEFAULT_GUILD_ID)
...
@lightbulb.command('translate', 'Update automatic text translation.')
@lightbulb.implements(lightbulb.SlashCommandGroup)
async def translate(ctx: lightbulb.Context) -> None:
    return

## Translate Set Command ##
...
## Translate Minimum Relative Distance Command ##
